...
<Hint>
  the <InlineCode>pointerenter</InlineCode> and <InlineCode>pointerleave</InlineCode> events work exactly the same as
  pointerover and pointerout. The
...
<Hint>
  ...
  <InlineCode>eventObject</InlineCode> and the ray. When this happens, the event will contain intersection data from a previous
